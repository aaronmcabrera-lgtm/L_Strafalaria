        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-white/70 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
            ...
            <span className="text-[#D4AF37] font-medium">
              {" "}Confianza que se gana en la cancha y fuera de ella.
            </span>
          </p>
        </div>

        {/* ESTRUCTURA ASIMÉTRICA CON IMAGEN FIJA A LA IZQUIERDA */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          
          {/* COLUMNA IZQUIERDA: IMAGEN DESDE TU RUTA EN PUBLIC (Ocupa 5 de 12 columnas) */}
          <div className="lg:col-span-5 w-full min-h-[350px] lg:min-h-full relative rounded-2xl overflow-hidden bg-zinc-900">
            <img 
              src="/trust/jugador.png" /* Reemplaza 'jugador.png' por el nombre exacto de tu archivo */
              alt="Strafalaria Premium Asset" 
              className="w-full h-full object-cover object-center absolute inset-0"
            />
            {/* Degradado sutil inferior para fusionar con el fondo negro */}
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
          </div>

          {/* COLUMNA DERECHA: TUS CUATRO TARJETAS INDEPENDIENTES ORIGINALES (Ocupa 7 de 12 columnas) */}
          <div className="lg:col-span-7 grid grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="border border-white/10 bg-white/5 p-5 text-center flex flex-col items-center justify-center rounded-xl">
              ...
              <div className="text-3xl md:text-4xl font-bold text-white font-antonio tracking-wide">
                300+
              </div>
              <div className="mt-1 text-[10px] tracking-[0.2em] uppercase text-white/60">
                piezas entregadas
              </div>
            </div>
